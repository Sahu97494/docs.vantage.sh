...
- Category
- Subcategory
- Charge Type (see the [section below](/cost_reports#charge-type-grouping-category) for definitions)
...
<Frame>
![Drilling down by parent nested tag](https://assets.vantage.sh/docs/nested-drilldown-1.png)
</Frame>
...
<Frame>
![Drilling down by subtag](https://assets.vantage.sh/docs/nested-drilldown-2.png)
</Frame>
