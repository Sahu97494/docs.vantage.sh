---
title: Budgets
description: "You can create and assign a _budget_ to a Cost Report. Once a budget is assigned, it's easy to see how costs are trending for a particular service, business unit, or team. You can also create _budget alerts_ to alert you based on configurable thresholds."
---
...
<Accordion title="Click to view example image">
  <Frame>
    <video
      ...
      src="https://assets.vantage.sh/docs/budget-overwrite.mp4"
    ></video>
  </Frame>
</Accordion>
...
<Frame>
  <video
    ...
    loop
    className="w-full aspect-video rounded-xl"
    src="https://assets.vantage.sh/docs/budget-hierarchy.mp4"
  ></video>
</Frame>
