...
### Step 4 - Prompt the Vantage MCP Server
    <Tabs>
        <Tab title="Claude">
        Start a new chat to begin prompting Claude. For example, you can ask, *“In Vantage, which workspaces do I have access to?”* Claude uses the appropriate [MCP tool](/vantage_mcp#vantage-mcp-tools) and replies with workspace access details.
        ...
        **NOTE**
        ...
        <Tab title="Goose">
        Start a new chat to begin prompting Goose. For example, you can ask, *“In Vantage, which workspaces do I have access to?”* Goose uses the appropriate [MCP tool](/vantage_mcp#vantage-mcp-tools) and replies with workspace access details.
