...
<Steps>
    <Step>
    Log in to the [Twilio console](https://console.twilio.com/). Ensure you are logged in to your main Twilio account. (See the [section above](/connecting_twilio#twilio-account-limitations) for information on limitations between main and subaccounts.)
    </Step>
    <Step>
